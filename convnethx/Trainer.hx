...
class Trainer {
    ...
    public var k:Int;
    public var gsum:Array<Float64Array>;
    public var xsum:Array<Float64Array>;
    ...
    public function train(x:Vol, y:Vol, volList:Array<Vol> = null) {
        ...
        if (this.k % this.batch_size == 0) {
            var pglist:Array<Dynamic> = this.net.getParamsAndGrads();
            ...
            for (i in 0 ... pglist.length) {
                var pg:Dynamic = pglist[i]; // param, gradient, other options in future (custom learning rate etc)
                ...
                for (j in 0 ... plen) {
                    ...
                    } else if(this.method == TrainerMethod.NETSTEROV) {
